...
class NestedScrollViewExtensionsSwipe(swipeAction: ViewAction = ViewActions.swipeUp()) :
...
class NestedScrollViewExtensionsScroll(scrollAction: ViewAction = ViewActions.scrollTo()) :
